...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post p1= new Post(null, Instant.parse("2020-12-23T16:35:40Z"), "Let's go", "Travel to beach", u1);
        Post p2= new Post(null, Instant.parse("2020-06-15T18:45:10Z"), "Good Morning", "Going to work", u1);
